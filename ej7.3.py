...
año = int(input("ingresar el año, en numeros por supuesto, osea no me pongas dosmil veintiuno, ni que estemos en "
                "colegio catolico que tengamos que escribir tan formal: "))
invalido = int(input("si pones mes, dia, año escribe 1, si pone dia, mes, año pon 2:"))


def EsValidaLaCosaONoSignoDePregunta(dia, mes, año, invalido):
    if invalido > 2:
...
print(EsValidaLaCosaONoSignoDePregunta(dia, mes, año, invalido))
